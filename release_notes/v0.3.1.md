...
This patch release adds **4 new Arduino-inspired functions** for querying and manipulating pin states, making it easier to check pin configurations and toggle outputs efficiently.
...
- ✅ libgpiod 2.2.1
- ✅ GCC 14.2.0 with `-Werror` (warnings as errors)
- ✅ CMake 3.31.6
...
If you find this library useful, please ⭐ star the repository and share it with the maker community!
