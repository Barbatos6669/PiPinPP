...
This patch release adds **Arduino-inspired angle conversion constants** (`DEG_TO_RAD` and `RAD_TO_DEG`) for use with standard library trigonometric functions. Following our v0.3.2 design philosophy, we provide only Arduino-specific constants that don't conflict with the C++ standard library.
...
The conversion constants provide Arduino-inspired API without conflicts!

---

## 📚 Comprehensive Example: `trig_functions`
...
### 6. **Servo Positioning**
Convert servo angles (0-180°) to pulse widths (1000-2000µs):
